                    ...
                    <div className="сookies__content">
                        ...
                        <p className="сookies__list-title">Анализируя более подробно, наши файлы cookie позволяют:</p>
                            <ul className="сookies__list">
                                ...
                                <li className="сookies__list-item list-item_circleList ">анализировать использование сервисов и контента, предоставляемых <a href="/">recyclex.online</a>, чтобы оптимизировать ваше пребывание на сайте и предлагаемые возможности.</li>
                            </ul>
                        </div>
                        <div className="сookies-type__wrapper">
                            ...
                            <p className="сookies__text">Сайт может содержать ссылки на другие веб-сайты, которые имеют собственную политику конфиденциальности, которая может отличаться от политики, принятой <a href="/">recyclex.online</a>, а поэтому мы не несем за эти веб-сайты ответственность.</p>
                        </div>
                        <div className="сookies-info__wrapper">
                            ...
                            <p className="сookies__text">Файл cookie PHPSESSID очень распространен в проектах, реализованных в средах Linux. Это технический файл cookie, в котором хранится буквенно-цифровое значение, идентифицирующее сеанс пользователя. Этот файл cookie удаляется после закрытия окна браузера и не хранит никакой личной информации. Если вы хотите подробнее узнать, каким образом ваш браузер сохраняет файлы cookie во время вашей навигации, пройдите по следующим ссылкам на веб-сайтах соответствующих поставщиков услуг.</p>
                            <h2 className="сookies__subtitle">Как отключить файлы cookie через настройку браузера</h2>
                            <p className="сookies__text">Если вы хотите подробнее узнать, каким образом ваш браузер сохраняет файлы cookie во время вашей навигации, пройдите по следующим ссылкам на веб-сайтах соответствующих поставщиков услуг. </p>
                        </div>
