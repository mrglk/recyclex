        ...
        <section className="agreement container__row">
            <h1 className="agreement__title">Соглашение об обработке персональных данных</h1>
                <div className="agreement__content">
                    ...
                    <p className="agreement__text">Согласен на получение по электронной почте, посредством смс-сообщений, телефонных звонков, рассылок через сервисы Viber, WhatsApp, Telegram и другие сервисы рекламных и информационных сообщений о товарах/услугах ООО «Экополимер», о деятельности ООО «Экополимер», о проведении стимулирующих мероприятий рекламного характера.</p>
                    <p className="agreement__text">Я проинформирован, что для решения вопросов, касающихся обработки принадлежащих мне персональных данных, я могу направить запрос оператору с темой письма «Запрос о персональных данных» (либо «Отзыв согласия на обработку персональных данных» - в случае отзыва согласия на обработку персональных данных) на адрес: <address>123112, г. Москва, Пресненская набережная, д.12, офис 405, помещ. 3.</address> </p>
